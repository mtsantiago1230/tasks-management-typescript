...
class TaskValidators {
    ...
    static validatePriority(priority) {
        ...
        const validPriorities = Object.values(types_1.TaskPriority);
    ...
    static validateStatus(status) {
        ...
        const validStatuses = Object.values(types_1.TaskStatus);
    ...
    static validateCreateTask(taskData) {
        const errors = [];
        // Validar título
    ...
    static validateUpdateTask(updates) {
        const errors = [];
...
exports.TaskValidators = TaskValidators;
